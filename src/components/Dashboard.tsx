  ...
  return (
    <div className="space-y-6">
        ...
        <div className="bg-white rounded-xl shadow-md p-6 border-l-4 border-blue-500">
          <div className="flex items-center justify-between">
            <div>
              ...
              <p className={`text-3xl font-bold mt-2 ${totals.saldo >= 0 ? 'text-blue-600' : 'text-red-600'}`}>
      ...
      <div className="grid grid-cols-1 lg:grid-cols-2 gap-6">
        ...
        {/* Categorias */}
        <div className="bg-white rounded-xl shadow-md p-6">
          <h2 className="text-xl font-bold text-gray-800 mb-4">Por Categoria</h2>
          {Object.keys(categoriesData).length === 0 ? (
            <p className="text-gray-500 text-center py-8">Nenhuma categoria registrada</p>
          ) : (
            <div className="space-y-3">
              {Object.entries(categoriesData)
                ...
                .map(([categoria, data]) => (
                  <div key={categoria} className="flex items-center justify-between">
                    <div className="flex-1">
                      <p className="font-medium text-gray-800 capitalize">{categoria}</p>
                      <p className="text-sm text-gray-500">{data.count} transações</p>
                    </div>
